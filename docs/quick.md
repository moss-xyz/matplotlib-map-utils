...
- The `imsize` of the inset map, in inches (providing a single number creates a square plot)
...
iax = inset_map(ax=ax, location="upper right", imsize=0.75, pad=0, xticks=[], yticks=[])
